#+title: The =emacs-compost-mode= README
# variables: emacs-compost-mode, A Note-taking mode for GNU Emacs
#+subtitle: A Note-taking mode for GNU Emacs
#+date: <2022-06-13 Mon 17:54>
#+description: A Note-taking mode for GNU Emacs
...
#+macro: summary A Note-taking mode for GNU Emacs.
#+macro: installinfo (eval (cdr:readme-install-instructions "emacs-compost-mode" "emacs" "compost"))
#+macro: useinfo (eval (cdr:readme-std-usage-instructions "emacs-compost-mode"))
#+macro: contribinfo (eval (cdr:readme-contrib-instructions "emacs-compost-mode"))
#+macro: licenseinfo (eval (cdr:readme-license-instructions "emacs-compost-mode" "agpl"))
** {{{TITLE}}}
